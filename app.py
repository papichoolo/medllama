...
model = AutoModelForCausalLM.from_pretrained("daryl149/llama-2-7b-chat-hf", torch_dtype=torch.float16, device_map='auto')
...
prompt = """
[INST] shOULD I BUY ADDERAL FOR MY ADHD?? :[/INST]
:
""".strip()
...
You are a doctor. Answer in concise medical terminology in giving diagnosis in no more than 50 words
<</SYS>>
...
gr.ChatInterface(fn=get_model_response,
    chatbot=gr.Chatbot(show_label=False, show_share_button=False, show_copy_button=True, likeable=True, layout="panel"),
                 title="Medllama : The Medically Fine-tuned LLaMA-2").launch(debug=True)
